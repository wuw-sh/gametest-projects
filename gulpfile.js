...
const bpfoldername = "Scripting-MCPE";
...
function watch() {
    return gulp.watch(["src/**/*.ts", "behavior_packs/**/*", "resource_packs/**/*"],
...
function serve() {
    return gulp.watch(
        [includeFile.ts, "behavior_packs/**/*", "resource_packs/**/*"],
        gulp.series(stopServer, build, deploy_localmc, startServer)
    ), gulp.watch(
        [includeFile.js, "behavior_packs/**/*", "resource_packs/**/*"],
        gulp.series(stopServer, build, deploy_localmc, startServer)
    );
}
